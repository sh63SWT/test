        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    @if($userUp->icon)
                        <td>
                            <img src="{{URL::asset('img/')}}/{{$userUp->icon}}" height="60px"  width="60px" alt="">
                        </td>
                    @else
                        <td>
                            <img src="{{URL::asset('img/admin/default.png')}}" height="60px" width="60px" alt="">
                        </td>
                    @endif
                ...
                <tr>
                    ...
                    <td>
                        <input id = "name" type="text" class="mg" name="name" value="{{$userUp->name}}">
                ...
                <tr>
                    <th>用户邮箱：</th>
                    <td>
                        <input id="email" type="email" class="mg" name="email" value="{{$userUp->email}}">
                        {{--@if (count($errors) > 0)--}}
                ...
                <tr>
                    <th>用户电话：</th>
                    <td>
                        <input id="phone" maxlength="11" type="text" class="mg" name="phone" value="{{$userUp->phone}}">
                        {{--@if (count($errors) > 0)--}}
                ...
                <tr>
                    <th>用户生日：</th>
                    <td>
                        <input id="birthday" type="date" class="mg" name="birthday" value="{{$userUp->birthday}}">
                        {{--@if (count($errors) > 0)--}}
                ...
                <tr>
                    <th>注册时间：</th>
                    <td>
                        <input id="reg" readonly="readonly" type="text" class="mg" name="reg" value="{{$userUp->created_at}}">
                        {{--@if (count($errors) > 0)--}}
                ...
                <tr>
                    <th>用户密码：</th>
                    <td>
                        <input id="password" type="password" class="mg" name="password" value="{{$userUp->password}}">
                        {{--@if (count($errors) > 0)--}}
