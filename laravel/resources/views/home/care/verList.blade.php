			...
			<div class="tube tube-b">
				<div class="block">
					...
					<div class="box nav-box">
						<!--面包屑 s-->
						<h2 class="line">
							<a href="https://www.duitang.com/people/?user_id=15081883">我的堆糖</a> &gt; 我的粉丝
						</h2>
					</div>
					<div class="box-d box rs-plist">
						<div class="tt"><span class="l b">我的粉丝</span></div>
						<!-- 关注列表人物 -->
						@if($cares)
							<div class="cont">
							<ul id="pp-dblist" class="ctr-dblist ctr-dblistpro pp-dblist">
								...
								@foreach($cares as $value)
									<li>
										<div class="pimg">
											<a href="https://www.duitang.com/people/?user_id=802129">
												@if($value->icon)
													<td>
														<img src="{{URL::asset('img/')}}/{{$value->icon}}" height="50px"  width="50px" alt="">
													</td>
												@else
													<td>
														<img src="{{URL::asset('img/admin/default.png')}}" height="50px" width="50px" alt="">
													</td>
												@endif
											</a>
										</div>
										<div class="th">
											<b><a href="https://www.duitang.com/people/?user_id=802129" class="ppdaren">{{$value->name}}</a></b>
											<div class="r psoper">
												<!-- 未关注 -->
												@if($value->sta == 0)
												<!-- 关注 -->
													<a class="l lkl graylk">粉丝</a>
													<a href="/home/addver/{{$value->id}}" class="l lkl graylk">加关注</a>{{--粉丝时可以关注它--}}
												...
												<!-- 互相关注 -->
													...
													<a href="/home/delver/{{$value->id}}" class="l lkl graylk">取消</a>{{--相互关注时可以取消关注它--}}
{{--													<a href="/home/delver/{{$value->id}}" class="unfollow followeo" href="javascript:;" data-follow="{&quot;rel&quot;:3,&quot;id&quot;:&quot;15051101&quot;,&quot;name&quot;:&quot;__许诺&quot;}" title="已关注" onmousedown="$.G.gaq(['_trackPageview', '/_trc/Follow/_/add_del']);"><i></i>已关注</a>--}}
													<a href="/care/catList/{{$value->id}}" class="l lkl graylk" data-sendto="{&quot;id&quot;:&quot;15051101&quot;,&quot;name&quot;:&quot;__许诺&quot;}" href="javascript:;">发私信</a>
												@endif
											</div>
										</div>
						...
						@else
							<div class="tc zero">
								...
								<div class="zero-cont dib">暂时没有粉丝。</div>
							</div>
						@endif
					<!-- 页码 -->
						<div class="pager">
